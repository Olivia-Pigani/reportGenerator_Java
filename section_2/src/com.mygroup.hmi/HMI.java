...
import com.mygroup.report.Sale;
...
public class HMI {
	...
	public void readReportMenu(){
		...
		File directory = new File(ReportUtil.REPORT_ROOT_FILEPATH);
		...
		if(allReportFiles != null && allReportFiles.length>0){
			...
			if(selectedFile != null){
				IoUtil.readBinaryFile(ReportUtil.REPORT_ROOT_FILEPATH,selectedFile.getName());
				IoUtil.readTextFile(ReportUtil.REPORT_ROOT_FILEPATH,selectedFile.getName());
			} else {
